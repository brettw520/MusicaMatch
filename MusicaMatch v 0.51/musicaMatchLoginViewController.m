//
//  musicaMatchLoginViewController.m
//  MusicaMatch v0.51
//
...
@interface musicaMatchLoginViewController()

@property (nonatomic, strong) UIImageView *fieldsBackground;

@end

@implementation musicaMatchLoginViewController
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.facebookButton setFrame:CGRectMake(35.0f, 320.0f, 120.0f, 40.0f)];
    [self.logInView.twitterButton setFrame:CGRectMake(35.0f+130.0f, 320.0f, 120.0f, 40.0f)];
